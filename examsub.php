...
fjs.parentNode.insertBefore(js, fjs);
    ...
    <header class="bg-danger text-white">
	  ...
	  <a href="test.php">	<button class="btn btn-success" style="40%">Test Area </button> </a>
...
<div class="panel-body">
					...
					<center>								
                          ...
                          $catname = $_GET['catname'];
							$sqlsub = "SELECT DISTINCT testno from question WHERE catid = $catid  order by id desc";
							$resultsub = mysqli_query($conn, $sqlsub);

    
							while($rowsub = mysqli_fetch_assoc($resultsub))
							{
                            $testno = $rowsub['testno'];
                            $title = $rowsub['title'];
							$_SESSION['subject'] = $testno;
							$subtitle = $catname."-". $testno;
							$_SESSION['title'] = $subtitle;

                            echo $subtitle;
							?>
							<a href="qustion.php?testno=<?php echo $rowsub['testno']; ?>">
							<?php echo"<button class='btn btn-info' style='width:60%'>Online Test:" .$subtitle."</button><hr />"; }?>
