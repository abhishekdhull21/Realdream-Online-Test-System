...
$sql = ("INSERT INTO question (examcode, qus,option1,option2,option3,option4, rightans,explanation) VALUES ('$catid', '".$_POST[$i.'qus']."', '".$_POST[$i.'aoption']."', '".$_POST[$i.'boption']."', '".$_POST[$i.'coption']."', '".$_POST[$i.'doption']."','".$_POST[$i.'rightans']."','".$_POST[$i.'exp']."')");
