    ...
    <div class="tab-content">
			...
			<div id="home" class="tab-pane fade">
				...
				<div class="panel panel-primary ">
									<div class="panel-heading"><h3 style="color:white; font-size:28px; text-align:center;"><?php echo $_POST['title']; ?> ANSWER SHEET</h3></div>
					 ...
					 <?php
							...
							$empty = 0;
							$ans=implode("",$_POST);
							$sqlqus = "SELECT * FROM `weektest` WHERE examName = '$_POST[examcode]' ";
		    ...
		    <div class="panel-heading"><h3 style="color:white; font-size:28px; text-align:center;"> TOTAL RESULT</h3></div>
			 <div class="panel-body" >
		      ...
		      <tr>
		        ...
		        <td style="font-size: 18px" ><?php echo $per; ?></td>
		      </tr>
		...
		<br>
		<div class="container">
			<a href="weekTestSeries.php?cid=<?php echo $_POST['examcode']; ?>"><button class="btn btn-primary">More <?php echo $_POST['title']; ?> Test </button></a>
		</div>

<?php 
  $sql = "INSERT INTO `sdata`(`sid`, `dexamcode`, `title`,`totalqus`, `rightqus`, `avg`) VALUES ('$sid','$_POST[examcode]','$_POST[title]','$total','$right','$per')";
